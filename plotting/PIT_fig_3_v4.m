...
%% >>>>>>>>>> Average field anisotropy
    ...
    ax1 = axes('Units','pixels','Position',[xnow ynow 220 90]);
        ah = add_panel_title('C',sprintf('Average field anisotropy'),'yoffset',-10,'xoffset',45,'width',400,'fontsize',fs);     
...
%% >>>>>>>>>> Behaviour anisotropy map 
    ...
    % plot arena
    ax1 = axes('Units','pixels','Position',[xnow ynow 220 90]);
        ah = add_panel_title('D',sprintf('Average behavioural anisotropy'),'yoffset',-10,'xoffset',45,'width',400,'fontsize',fs);     
    ...
    ax3 = axes('Units','pixels','Position',[ax2.Position(1)+xbuff ax2.Position(2) ax1.Position(3) ax1.Position(4)]);
        ...
        % text
        text(0,0,sprintf('%s, %d sessions',maze_names{3},size(all_amaps_a1,3)),'Units','normalized','HorizontalAlignment','left','VerticalAlignment','top','FontSize',8,'Color','k')
...
%% >>>>>>>>>> Expected anisotropy map (walls only)
    ...
    % plot arena
    ax1 = axes('Units','pixels','Position',[xnow ynow 220 90]);
        ah = add_panel_title('E',sprintf('Elongation is not explained by geometry alone'),'yoffset',-10,'xoffset',45,'width',400,'fontsize',fs);     
...
%% >>>>>>>>>> Expected anisotropy map (walls only)
    ...
    % plot arena
    ax1 = axes('Units','pixels','Position',[xnow ynow 220 90]);
        ah = add_panel_title('F',sprintf('Elongation is explained by geometry + terrain'),'yoffset',-10,'xoffset',45,'width',400,'fontsize',fs);     
