function [lx,ly,lz] = fit_hill_frame(pdata,skipman)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% >>>>>>>>>> arena1 data
    ...
    part_now = pdata.part_config.part_names{1};
    ppox = double( pdata.(part_now).pox ); % pos x for this part, cm
    ppoy = double( pdata.(part_now).poy ); % pos y for this part, cm
    ppoz = double( pdata.(part_now).poz ); % pos z for this part, cm    
...
%% >>>>>>>>>> hills data
    ...
    part_now = pdata.part_config.part_names{2};
    ppox = double( pdata.(part_now).pox ); % pos x for this part, cm
    ppoy = double( pdata.(part_now).poy ); % pos y for this part, cm
    ppoz = double( pdata.(part_now).poz ); % pos z for this part, cm   
...
%% >>>>>>>>>> arena2 data
    ...
    part_now = pdata.part_config.part_names{3};
    ppox = double( pdata.(part_now).pox ); % pos x for this part, cm
    ppoy = double( pdata.(part_now).poy ); % pos y for this part, cm
    ppoz = double( pdata.(part_now).poz ); % pos z for this part, cm    
...
%% function to control lattice XY position
    ...
    % save figure
    if print_now
        fname = [pwd '\' pdata.outname '\maze_frame.png'];        
